...
(
    SELECT 
        ...
        CASE MONEDA
            WHEN 1
                THEN LPAD(TO_CHAR(MONTOPRESTAMO,'FM9999999.90'), 15)
            WHEN 2
                THEN LPAD(TO_CHAR(ROUND(MONTOPRESTAMO * GEN05200('31/12/2019', 3, 3), 2),'FM9999999.90'), 15)
        END MONTOPRESTAMO,

        CASE MONEDA
            WHEN 1
                THEN LPAD(TO_CHAR((MONTOPRESTAMO - SALDOPRESTAMO),'FM9999999.90'), 15)
            WHEN 2
                THEN LPAD(TO_CHAR(ROUND((MONTOPRESTAMO - SALDOPRESTAMO) * GEN05200('31/12/2019', 3, 3), 2),'FM9999999.90'), 15)
        END AMORTIZACIONTOTAL,

        CASE MONEDA
            WHEN 1
                THEN LPAD(TO_CHAR(INTERESTOTAL,'FM9999999.90'), 15)
            WHEN 2
                THEN LPAD(TO_CHAR(ROUND(INTERESTOTAL * GEN05200('31/12/2019', 3, 3), 2),'FM9999999.90'), 15)
        END INTERESTOTAL,
